...
contract ValidationIntersectionTest is AccountTestBase {
    ...
    function setUp() public {
        ...
        noHookValidation = FunctionReferenceLib.pack({
            ...
            validationId: uint32(MockBaseUserOpValidationPlugin.ValidationId.USER_OP_VALIDATION)
        });
        ...
        preValidationHooks[0] = FunctionReferenceLib.pack({
            addr: address(oneHookPlugin),
            validationId: uint32(MockBaseUserOpValidationPlugin.ValidationId.PRE_VALIDATION_HOOK_1)
        });
        ...
        preValidationHooks[1] = FunctionReferenceLib.pack({
            addr: address(twoHookPlugin),
            validationId: uint32(MockBaseUserOpValidationPlugin.ValidationId.PRE_VALIDATION_HOOK_2)
        });
